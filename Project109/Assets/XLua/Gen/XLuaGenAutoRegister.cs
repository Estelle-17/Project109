...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(ActionCardData), ActionCardDataWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(RelicData), RelicDataWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Choice_UseItem), Choice_UseItemWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(System.Collections.Generic.List<ActionCardData>), SystemCollectionsGenericList_1_ActionCardData_Wrap.__Register);
