...
public class EvolveCardHandler : UIPanelBase
{
    public EvolveCardCheckHandler evolveCardCheckHandler;
    ...
    void AddCardClickEvent(ActionCardHandler cardHandler)
    {
        ...
        cardHandler.OnCardClick.AddListener(() => CheckEvolveCard(cardData));
    }

    void CheckEvolveCard(ActionCardData newCardData)
    {
        evolveCardCheckHandler.OnCardCheckUI(newCardData);
    }
}
