...
namespace XLua.CSObjectWrap
{
    ...
    public class ChoiceDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ChoiceData);
			Utils.BeginObjectRegister(type, L, translator, 0, 0, 3, 3);
			
			
			
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "description", _g_get_description);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "nextNodeID", _g_get_nextNodeID);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "nextNodeID", _s_set_nextNodeID);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ChoiceData constructor!");
        ...
        static int _g_get_description(RealStatePtr L)
        {
		    try {
                ...
                ChoiceData gen_to_be_invoked = (ChoiceData)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_nextNodeID(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                ChoiceData gen_to_be_invoked = (ChoiceData)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.nextNodeID);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_nextNodeID(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                ChoiceData gen_to_be_invoked = (ChoiceData)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.nextNodeID = LuaAPI.lua_tostring(L, 2);
